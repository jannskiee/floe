...
| ---------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| disk             | per-component sanitize + traversal filter                                                                                                                                                                                                                                                                 | Go: safeJoin -> sanitizeComponent (receiver.go); desktop OpenFile/RevealFile -> safeLeaf (reveal.go); browser: sanitizeFileName for the download attribute, sanitizeZipEntryName for archives (download.ts) |
...
download.test.ts, receiver.test.ts, receiverHash.test.ts (the per-file SHA-256 checks),
sender.test.ts, protocol.test.ts (classifyControl and the message builders) (browser); incoming.test.ts / errors.test.ts (desktop).
