...
sending: the web app holds its room open for the receiver to come back, while `floe send` and the
desktop app end the transfer as soon as the receiving side goes.
