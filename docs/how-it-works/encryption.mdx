...
description: "How Floe uses WebRTC DTLS-SRTP to end-to-end encrypt every file transfer so neither the signaling server nor the TURN relay can read your data."
---
