...
link gets an error. Once the recipient has joined, the room code stops working and the link turns
away anyone on a network other than yours or the recipient's. Send again for a second recipient. See
