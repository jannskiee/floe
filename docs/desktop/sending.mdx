...
When it finishes you get a Windows notification and the card counts what went out: **Sent 1 item**,
or **Sent 4 items** for a batch. A text note counts as one item, because it travels as a single
`message.txt`.
