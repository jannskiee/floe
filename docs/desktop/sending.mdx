...
starting over discards it. Clicking the Floe lockup in the title bar starts over too, with the
...
link gets an error. Once the recipient has joined, the room code stops working, and once your two
devices have started connecting, the link turns away anyone on a network other than yours or the
recipient's. Send again for a second recipient. See
