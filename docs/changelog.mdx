...
{/*
  ...
  3. `tags` come from exactly four values, spelled exactly like this:
       "floe.one"      the web app, and self-hosted web clients
       "Floe Desktop"  the Windows app
       "floe CLI"      the floe command
       "Your server"   running your own server or container images
     The FIRST tag is the entry's primary surface, the one the bold headline is
     about. The rest follow in the order listed above.
     These values are deliberately unfusable. Mintlify renders them in the left
     gutter as bare space-separated text with no delimiter, so bare modifiers
     like "Web" and "CLI" ran together into phantom phrases ("CLI Web"). Every
     value must begin with a token that can only open a noun phrase and never
     continue one: a domain, a product name, or a determiner. Apply that test
     before adding a fifth. See docs/style.css for the separator.
...
Floe ships on two version lines. `vX.Y.Z` releases floe.one, the `floe` CLI, and the server you can run yourself. `desktop-vX.Y.Z` releases Floe Desktop for Windows. The two never need to match, and any two copies of Floe transfer with each other in every direction.

Each entry lists the parts it changed. Filter on the right to see only the ones you use.

<Update label="Unreleased" tags={["floe CLI"]}>
...
<Update label="desktop-v0.2.2" description="2026-08-08" tags={["Floe Desktop"]}>
  **A redrawn app icon, and two things that used to fail silently**

  - The app icon is redrawn to match the mark on floe.one. The bolt is larger and its corners are rounded, so the app, the website and the docs finally show the same logo.
  ...
  - Fixed the app exiting without a word when it could not start. Release builds have no console, so a failure before the window appeared killed the process in silence. The usual cause is the WebView2 runtime being unreachable, offline or behind a filtering proxy. You now get a message box naming the problem, with a WebView2 hint where that is what went wrong.
  - Fixed **Start over** throwing away a typed note without asking. `Ctrl` `R` is now ignored while the cursor is in a field, and confirmation is required when a note is waiting to be sent. Staged files are still cleared without a prompt, since the files themselves are untouched on disk.
...
<Update label="desktop-v0.2.1" description="2026-08-02" tags={["Floe Desktop"]}>
...
<Update label="desktop-v0.2.0" description="2026-08-02" tags={["Floe Desktop"]}>
...
<Update label="desktop-v0.1.0" description="2026-08-01" tags={["Floe Desktop"]}>
...
<Update label="v1.9.1" description="2026-07-30" tags={["Your server"]}>
...
<Update label="v1.9.0" description="2026-07-30" tags={["Your server", "floe CLI"]}>
...
<Update label="v1.8.0" description="2026-07-23" tags={["floe CLI"]}>
...
<Update label="v1.7.6" description="2026-07-21" tags={["floe CLI", "floe.one"]}>
...
<Update label="v1.7.5" description="2026-07-10" tags={["floe CLI", "floe.one"]}>
...
<Update label="v1.7.4" description="2026-07-10" tags={["floe CLI", "floe.one", "Your server"]}>
...
<Update label="v1.7.3" description="2026-07-09" tags={["floe CLI", "floe.one"]}>
...
<Update label="v1.7.2" description="2026-06-30" tags={["floe CLI"]}>
...
<Update label="v1.7.1" description="2026-06-22" tags={["floe CLI"]}>
...
<Update label="v1.7.0" description="2026-06-22" tags={["floe.one", "floe CLI", "Your server"]}>
...
<Update label="v1.6.0" description="2026-06-22" tags={["floe CLI", "floe.one"]}>
...
<Update label="v1.5.5" description="2026-06-21" tags={["floe CLI"]}>
...
<Update label="v1.5.4" description="2026-06-21" tags={["floe CLI"]}>
...
<Update label="v1.5.3" description="2026-06-21" tags={["floe CLI"]}>
...
<Update label="v1.5.2" description="2026-06-17" tags={["floe CLI"]}>
  **CLI stability fix**
...
<Update label="v1.5.1" description="2026-06-17" tags={["floe CLI"]}>
...
<Update label="v1.5.0" description="2026-06-17" tags={["floe CLI"]}>
...
<Update label="v1.4.0" description="2026-06-17" tags={["floe CLI"]}>
...
<Update label="v1.3.0" description="2026-06-17" tags={["floe CLI", "floe.one", "Your server"]}>
...
<Update label="v1.2.0" description="2026-06-16" tags={["floe CLI"]}>
...
<Update label="v1.1.0" description="2026-06-16" tags={["floe CLI", "floe.one"]}>
...
<Update label="v1.0.0" description="2026-06-14" tags={["floe.one", "floe CLI", "Your server"]}>
