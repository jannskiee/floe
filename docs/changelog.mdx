...
<Update label="v1.10.6" description="2026-08-29" tags={["CLI", "Web", "Self-hosting"]}>
  **The CLI can hide your IP address by forcing the relay, and says which route each transfer took**
  ...
  - Self-hosting: the published images are rebuilt as `1.10.6`, picking up Next.js 16.3.3, which fixes two advisories rated critical in Next.js itself. Update rather than waiting. If you pinned `FLOE_IMAGE_TAG=1.10.5`, move to `1.10.6`.
