...
The **Verify** line is the connection verification code; the sender shows the same eight digits, and comparing them rules out an intercepted connection. Checking is optional. See [floe send](/cli/send) for the full explanation.
