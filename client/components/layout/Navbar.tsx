            ...
            <div className="pointer-events-auto flex items-center gap-1 max-[359px]:gap-0.5 rounded-full border border-white/10 bg-zinc-900/70 p-1.5 max-[359px]:p-1 shadow-2xl backdrop-blur-xl">
                ...
                <div className="flex items-center gap-0.5 sm:gap-1">
                    ...
                    <a
                        ...
                        aria-label="GitHub"
                        title="GitHub"
                        className="flex items-center justify-center rounded-full p-2 max-[359px]:p-1.5 text-zinc-400 transition hover:bg-white/10 hover:text-white focus-visible:outline-2 focus-visible:outline-ice"
                    >
