...
export const Navbar = () => {
    ...
    return (
        <nav aria-label="Main" className="fixed top-0 left-0 right-0 z-50 flex justify-center py-6 pointer-events-none">
            <div className="pointer-events-auto flex items-center gap-1 rounded-full border border-white/10 bg-zinc-900/70 p-1.5 shadow-2xl backdrop-blur-xl">
